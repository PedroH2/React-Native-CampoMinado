...
import {createMinedBoard, cloneBoard, hadExplosion, openField, flagsUsed, flagsLeft, showMines, wonGame, invertFlag} from './src/functions'
...
export default class App extends Component {
  ...
  minesAmount=()=>{
    const cols = params.getComulmnsAmount()
